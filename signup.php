...
<?php
	...
	$query = "INSERT INTO salesforce.user (FirstName, LastName, Alias, CommunityNickname, phone, mobilephone, street, city, postalcode, state, country, email, TimeZoneSidKey, LocaleSidKey,EmailEncodingKey, ProfileId, LanguageLocaleKey, Username, password__c) VALUES('$_POST[firstname]','$_POST[lastname]',"asdfg","qqwer",'$_POST[phonenumber]', '$_POST[mobilenumber]', '$_POST[street]', '$_POST[city]', '$_POST[zipcode]', '$_POST[state]', '$_POST[country]', '$_POST[emailid]', "America/LA", "English(United States)", "General US and Western Europe", "Service cloud", "English", '$_POST[emailid]', '$_POST[password]');";
